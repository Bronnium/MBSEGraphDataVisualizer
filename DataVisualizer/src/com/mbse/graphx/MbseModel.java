...
public class MbseModel extends mxGraph {
	...
	private void toggleSubtree(final mxGraph graph, final Object cellSelected, boolean show)
	{
		final List<Object> cellsAffected = new ArrayList<Object>();
	...
	public void setAppliedLayout(mxGraphLayout currentAppliedLayout) {
		this.appliedLayout = currentAppliedLayout;
	}
	...
	{
		appliedLayout.execute(this.getDefaultParent());
	}
